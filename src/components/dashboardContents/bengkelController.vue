<template>
    <v-container>
        ...
        <v-dialog v-model="dialog" persistent max-width="600px">
            <v-card>
                <v-card-title> <span class="headline">Bengkel Profile</span> </v-card-title>
                <v-card-text>
                    <v-container>
                        <v-row>
                            <v-col cols="12">
...
export default {
    ...
    methods:{
        getData(){
            var uri = this.$apiUrl + '/user/bengkel'
        ...
        updateData(){
            ...
            this.user.append('address', this.form.address);
            this.user.append('phoneNumber', this.form.phoneNumber);
            var uri = this.$apiUrl + '/user/bengkel/' + this.updatedId;
            this.load = true
        ...
        deleteData(deleteId){ //menghapus data
            var uri = this.$apiUrl + '/user/bengkel/' + deleteId; //data dihapus berdasarkan id
